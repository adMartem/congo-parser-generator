...
import org.parsers.test.FTTestsParser;
...
public class FTParse {
   ...
   static public void parseFile(File file, boolean dumpTree) throws IOException {
       FTTestsParser parser = new FTTestsParser(file.toPath());
   ...
   static public void usage() {
       System.out.println("Usage: java FTTestsParse <sourcefiles or directories>");
