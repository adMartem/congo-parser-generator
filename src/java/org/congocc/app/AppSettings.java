...
public class AppSettings {
    ...
    private final String booleanSettings = ",FAULT_TOLERANT,FAULT_TOLERANT_DEFAULT,PRESERVE_TABS,PRESERVE_LINE_ENDINGS,"
                                    ...
                                    + "USE_CHECKED_EXCEPTION,LEGACY_GLITCHY_LOOKAHEAD,TOKEN_CHAINING,USES_PREPROCESSOR,X_JTB_PARSE_TREE,X_SYNTHETIC_NODES_ENABLED,X_USE_DFA,";
    ...
    public boolean getUseDfa() {
        Boolean b = (Boolean) settings.get("X_USE_DFA");
        return b != null && b;
    }
